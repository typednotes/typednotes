...
COMMENT ON TABLE teams IS 'A team is created for everyone that signs up.';
COMMENT ON COLUMN teams.name IS 'The name of the team';
COMMENT ON COLUMN teams.created_by_user_id IS 'Created by';
...
COMMENT ON TABLE team_users IS 'A User can belong to multiple teams.';
...
COMMENT ON TABLE invitations IS 'Invitations are generated so users can join teams';
COMMENT ON COLUMN invitations.team_id IS 'The team that the user will join if they acccept the invite';
COMMENT ON COLUMN invitations.roles IS 'The RBAC privelages the user will receive on joining the team.';
...
GRANT SELECT, INSERT ON team_users TO typednotes_application;
GRANT SELECT, INSERT, UPDATE ON teams TO typednotes_application;
GRANT SELECT, INSERT, DELETE ON invitations TO typednotes_application;
GRANT USAGE, SELECT ON invitations_id_seq, teams_id_seq TO typednotes_application;

-- Give access to the readonly user
GRANT SELECT ON invitations, teams, team_users TO typednotes_readonly;
